(() => {
  ...
  function requestDetails(request) {
    ...
    const decisionEmail = decided ? (request.decidedByEmail || "") : "";
    const decisionDate = decided ? formatDecisionDate(request.decidedAt) : "Pending";
        ...
        <div class="leave-view-dialog">
          <div class="leave-form-card">
            ...
            <div class="leave-form-body leave-form-readonly">
              ...
              <div class="leave-supervisor-fields">
                <label>${escapeHtml(decisionLabel)}</label><input value="${escapeHtml(decisionName)}" readonly>
                <label>Decision Date:</label><input value="${escapeHtml(decisionDate)}" readonly>
                ${decisionEmail ? `<label>HR Manager Email:</label><input class="leave-decision-email" value="${escapeHtml(decisionEmail)}" readonly>` : ""}
                <label>Supervisor Signature:</label><input value="${escapeHtml(request.managerSignature || "")}" readonly>
              </div>
